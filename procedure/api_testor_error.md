...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 4; call api_testor_error( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'exception.1', 'Field is missing!' ); select @v_test_id, @v_suite_id, @v_case_id;
